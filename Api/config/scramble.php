...
return [
    ...
    'info' => [
         ...
         */
        'description' => 'Sistem Informasi Inventaris Sekolah — REST API untuk pengelolaan barang inventaris, mutasi, dan laporan kerusakan. Otentikasi menggunakan Sanctum SPA cookie-based.',
    ],

    'ui' => [
        'title' => 'InvenSchool API',
    ],
     ...
     */
    'servers' => [
        env('APP_URL', 'http://localhost').'/api',
    ],
